...
#  --ntasks-per-node=1
# #SBATCH --ntasks=8
#SBATCH -o /home/ekyzivat/slurm-logs/stdout/slurm_import_pixelclassifierTrain.j.%J.out # -o is stdout # must use full, absolute path
#SBATCH -e /home/ekyzivat/slurm-logs/stderr/slurm_import_pixelclassifierTrain.j.%J.err # -e is stderr

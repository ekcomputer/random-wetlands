...
if load_env 
    ...
    if ~isunix
        ...
        env.output.train_dir='F:\PAD2019\classification_training\PixelClassifier\Train15\';
        % env.output.train_dir='F:\PAD2019\classification_training\PixelClassifier\Train_origClass\Train';
        env.output.test_dir='F:\PAD2019\classification_training\PixelClassifier\Test15\';
        ...
        env.input(2).cls_pth=       'F:\PAD2019\classification_training\training2019PAD_CHECKPOINTDec2wTails.shp';
    ...
    %% classes
        ...
        % to meta file)
    env.class_names={'W1', 'W2', 'HW', 'GW', 'GD', 'SW', 'SD', 'FD', 'TD', 'TW'}; % {'W1', 'W2', 'EU', 'BG', 'HW', 'GW', 'GD', 'SW', 'SD', 'FW', 'FD'}, no BG; {'W1', 'W2', 'BG', 'HW', 'GW', 'GD', 'SW', 'SD', 'FD'}; % < prior to  Dec 2  
